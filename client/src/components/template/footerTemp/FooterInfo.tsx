...
function FooterInfo() {
  return (
    <div className="flex flex-col lg:flex-row lg:justify-start justify-between gap-x-10 gap-y-2 items-start pt-30 pb-14">
      <div className="flex flex-col gap-2 items-start">
        <div className="flex flex-row items-center gap-2">
          <FaLocationDot className="text-primary-30" />
          <p className="text-text-10/80 text-sm pt-2 ">
            <span className=" font-bold text-text-10">فروشگاه مرکزی</span> -
